...
## Run Information
- Mayhem Run: mayhemheroes/minimp4/minimp4-x86/3
- Git Commit: 563e2818bc0d811678b2f56313d1ebc295cf3a4e
- Original Image: ghcr.io/mayhemheroes/minimp4:master
- Target Executable: /minimp4_x86
- CI URL: https://github.com:443/mayhemheroes/minimp4/actions/runs/2690042572
...
- Source code: `/rlenv/source/minimp4/`
...
RUN cp <build-artifact> /minimp4_x86

# 11. Permission Management (REQUIRED)
RUN chmod 766 /minimp4_x86
...
- `COPY . /rlenv/source/minimp4/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/minimp4/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /minimp4_x86`
...
- [ ] Target executable in Dockerfile.rlenv: `/minimp4_x86`
- [ ] Target executable in build.sh: `/minimp4_x86`
- [ ] Target executable in metadata.json: `/minimp4_x86`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/minimp4/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/minimp4/fuzz
...
- Source copy: `COPY . /rlenv/source/minimp4/`
...
- Working directory: `cd /rlenv/source/minimp4/`
- No network access
